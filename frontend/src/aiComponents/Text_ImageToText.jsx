  ...
  return (
    <div className='pt-20 bg-gray-900 gradientbg' style={{ minHeight: '100vh' }}>
      <div className='flex justify-center p-8' style={{ minHeight: 'calc(100vh - 80px)' }}>
        <div
          className='min-w-[20rem] bg-slate-600 text-white rounded-2xl'
          style={{ minWidth: '300px', maxWidth: '900px', width: '99%' }}
        >
          <div id='inputs' className='p-3' style={{ minHeight: 'calc(100%-2.5rem)' }}>
            <div className='flex justify-between'>
              <p className='pb-2'>You can customise your prompts here.</p>
              <button onClick={handlePublish} className='px-2 pb-1 rounded bg-pink-300'>
                Publish
              </button>
            </div>
              ...
              <div key={divIndex} className='p-2 my-2 rounded border bg-gray-600 relative'>
                <div className='flex justify-between'>
                  ...
                  <button
                    ...
                    className='bg-red-900 px-2 rounded absolute -right-0 -top-0'
                  >
                    X
                  </button>
                </div>
            ...
            {images.map((divIndex, index) => (
              <div key={divIndex} className='p-2 my-2 rounded border bg-gray-600 relative'>
                <div className='flex justify-between'>
                  <p>
                    <span className='text-xs text-gray-300'>Placeholder for Image Input.</span>
                  </p>
                  <button
            ...
            <div className='flex justify-center mt-3'>
              <div className='flex gap-2'>
                <button
                  ...
                  className='p-0.5 pb-1 px-2 rounded bg-gray-400 hover:bg-slate-500'
                >
                  + Insert Texts
                </button>
                <button
                ...
                <button
                  onClick={TestApp}
                  className='p-0.5 pb-1 px-2 rounded bg-green-600 hover:bg-green-800'
                >
                  {'>'} Test
                </button>
              </div>
      ...
      >
        <div id='run' onClick={(e) => handleClickOutside(e, 'test')} className='flex items-center justify-center h-full'>
          <div
            className='bg-neutral-700 rounded-xl pt-5'
          ...
          >
            ...
            <div className='overflow-y-auto' style={{ height: 'calc(100% - 30px)' }}>
              ...
              <div className='text-white font-light p-3 px-5'>
                {isRunning ? <div>Running...</div> : <Markdown>{modelOutput}</Markdown>}
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div id='run' onClick={(e) => handleClickOutside(e, 'publish')} className='flex items-center justify-center h-full'>
          <div
            id='runMain'
            className='bg-slate-600 rounded-xl pt-5'
            style={{ height: 'calc(100vh - 180px)', maxWidth: '900px', width: '90%' }}
          >
            <div className='overflow-y-auto' style={{ height: 'calc(100% - 30px)' }}>
              <Publish data={final} />
